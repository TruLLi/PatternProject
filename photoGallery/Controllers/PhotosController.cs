...
namespace PatternProject.Controllers
{
    ...
    public class PhotosController : Controller
    {
        ...
        //ovo sam dao zbog abstract facrory patterna 
        //private IGalleryData galleryData = new GalleryData();
        ...
        {
            var testRepoa = _photoRepository.GetAll();

            var j = new JsonResult();
            j.Data = new { denis = testRepoa };
            return j;
        ...
        //    IGalleryItem photo = db.Photos.Find(id);
        //    if (photo == null)
        //    {
        //        return HttpNotFound();
        //    }
        ...
        //private IGalleryItem SetModifiedDate(IGalleryItem galleryItem)
        //{
        //    galleryItem.LastUpdatedDatetime = DateTime.Now;
        //    return galleryItem;
        //}
        ...
        //                var path = Path.Combine(Server.MapPath("~/Content/PatternProject/" + setAlbumName(photo.AlbumId)), filename);
        ...
        //    {
        //        Photo photo = db.Photos.Find(id);
        //        var path = Server.MapPath("~/Content/PatternProject/" + photo.Album.AlbumName);
        //        var filename = Path.Combine(Server.MapPath("~/Content/PatternProject/" + photo.Album.AlbumName), photo.ImageName);
